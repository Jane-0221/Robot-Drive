...
static void VL53L0X_CaptureBusDebug(void)
{
    ...
    vl53l0x_i2c_state = (uint8_t)HAL_I2C_GetState(&hi2c4);
    vl53l0x_i2c_isr = hi2c4.Instance->ISR;
    vl53l0x_i2c_cr2 = hi2c4.Instance->CR2;
    vl53l0x_i2c_busy_flag = (__HAL_I2C_GET_FLAG(&hi2c4, I2C_FLAG_BUSY) == SET) ? 1U : 0U;
}
...
void VL53L0X_UpdateBusDebug(void)
{
    ...
    if ((vl53l0x_i2c_busy_flag != 0U) || (HAL_I2C_GetState(&hi2c4) != HAL_I2C_STATE_READY))
    {
    ...
    vl53l0x_probe_52_status = (uint8_t)HAL_I2C_IsDeviceReady(&hi2c4, VL53L0X_I2C_HAL_ADDR, 1U, VL53L0X_I2C_TIMEOUT_MS);
    vl53l0x_probe_29_status = (uint8_t)HAL_I2C_IsDeviceReady(&hi2c4, (0x29U << 1), 1U, VL53L0X_I2C_TIMEOUT_MS);
    vl53l0x_probe_52_shift_status = (uint8_t)HAL_I2C_IsDeviceReady(&hi2c4, VL53L0X_I2C_SHIFT_ADDR, 1U, VL53L0X_I2C_TIMEOUT_MS);
    VL53L0X_CaptureBusDebug();
}
...
uint8_t VL53L0X_ScanI2C4(void)
{
    ...
    {
        HAL_StatusTypeDef hal_status = HAL_I2C_IsDeviceReady(&hi2c4,
                                                             ((uint16_t)dev_addr << 1),
                                                             1U,
...
VL53L0X_StatusTypeDef VL53L0X_Init(void)
{
    ...
    (void)VL53L0X_ScanI2C4();

    vl53l0x_last_hal_error = 0U;
    vl53l0x_error_step = VL53L0X_STEP_DEVICE_READY;
    hal_status = HAL_I2C_IsDeviceReady(&hi2c4, VL53L0X_I2C_HAL_ADDR, 2U, VL53L0X_I2C_TIMEOUT_MS);
    vl53l0x_last_hal_status = hal_status;
    if (hal_status != HAL_OK)
    {
        vl53l0x_last_hal_error = HAL_I2C_GetError(&hi2c4);
...
VL53L0X_StatusTypeDef VL53L0X_ReadDistance(void)
{
    ...
    hal_status = HAL_I2C_Master_Transmit(&hi2c4,
    ...
    hal_status = HAL_I2C_Master_Receive(&hi2c4,
                                        VL53L0X_I2C_HAL_ADDR,
                                        read_buf,
                                        VL53L0X_RESULT_LEN,
                                        VL53L0X_I2C_TIMEOUT_MS);
